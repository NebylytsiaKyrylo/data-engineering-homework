...
from job2.bll.process_sales import process_sales_data


@mock.patch("job2.bll.process_sales.os.path.isdir")
@mock.patch("job2.bll.process_sales.os.makedirs")
@mock.patch("job2.bll.process_sales.os.listdir")
@mock.patch("job2.bll.process_sales.read_json_file")
@mock.patch("job2.bll.process_sales.write_avro_file")
@mock.patch("job2.bll.process_sales.logger.info")
...
@mock.patch("job2.bll.process_sales.os.path.isdir")
@mock.patch("job2.bll.process_sales.logger.error")
...
@mock.patch("job2.bll.process_sales.os.listdir")
@mock.patch("job2.bll.process_sales.logger.info")
@mock.patch("job2.bll.process_sales.logger.exception")
