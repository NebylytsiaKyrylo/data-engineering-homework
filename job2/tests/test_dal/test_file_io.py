...
from job2.dal.file_io import read_json_file, write_avro_file, SALES_AVRO_SCHEMA


@mock.patch(
    "job2.dal.file_io.open",
    mock.mock_open(read_data='[{"client": "Test Client", "price": 100}]'),
)
@mock.patch("job2.dal.file_io.json.load")
@mock.patch("job2.dal.file_io.logger.info")
...
@mock.patch("job2.dal.file_io.open")
@mock.patch("job2.dal.file_io.logger.info")
@mock.patch("job2.dal.file_io.logger.error")
...
@mock.patch("job2.dal.file_io.open", mock.mock_open(read_data="invalid json"))
@mock.patch("job2.dal.file_io.json.load")
@mock.patch("job2.dal.file_io.logger.info")
@mock.patch("job2.dal.file_io.logger.error")
...
@mock.patch("job2.dal.file_io.open", mock.mock_open())
@mock.patch("job2.dal.file_io.fastavro.writer")
@mock.patch("job2.dal.file_io.logger.info")
...
@mock.patch("job2.dal.file_io.fastavro.writer")
@mock.patch("job2.dal.file_io.logger.info")
@mock.patch("job2.dal.file_io.logger.exception")
