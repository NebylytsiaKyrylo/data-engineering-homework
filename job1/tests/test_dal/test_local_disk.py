...
from job1.dal.local_disk import prepare_storage_dir, save_page_to_disk


@mock.patch("job1.dal.local_disk.os.path.exists")
@mock.patch("job1.dal.local_disk.shutil.rmtree")
@mock.patch("job1.dal.local_disk.os.makedirs")
@mock.patch("job1.dal.local_disk.logger.info")
...
@mock.patch("job1.dal.local_disk.os.makedirs")
@mock.patch("job1.dal.local_disk.logger.info")
@mock.patch("job1.dal.local_disk.logger.error")
...
@mock.patch("job1.dal.local_disk.open", mock.mock_open())
@mock.patch("job1.dal.local_disk.json.dump")
@mock.patch("job1.dal.local_disk.os.path.join")
@mock.patch("job1.dal.local_disk.logger.info")
...
@mock.patch("job1.dal.local_disk.open")
@mock.patch("job1.dal.local_disk.os.path.join")
@mock.patch("job1.dal.local_disk.logger.info")
@mock.patch("job1.dal.local_disk.logger.error")
...
@mock.patch("job1.dal.local_disk.os.path.join")
@mock.patch("job1.dal.local_disk.logger.info")
@mock.patch("job1.dal.local_disk.logger.exception")
